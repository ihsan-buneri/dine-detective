...
const ChatPage = () => {
    ...
    useEffect(() => {
        const fetchInitialMessages = async () => {
            try {
                let message: string = "Hello! I'm Sarah, your AI assistant. How can I help you today?";
            ...
            <div className="sticky top-0 z-50 bg-black/20 backdrop-blur-lg border-b border-cyan-500/20">
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <Button
                        ...
                        className="text-purple-400 cursor-pointer hover:text-purple-300 hover:bg-purple-500/10"
                    >
                ...
                <AnimatePresence>
                    {showProfile && (
                        <motion.div
                            ...
                            className="w-80"
                        >
                            <AuthModal isOpen={showProfile} onClose={() => setShowProfile(false)} />
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
